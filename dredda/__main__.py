...
def main_train(args):
    if os.path.isdir(args.out_dir):
        raise ValueError(f"{args.out_dir} already exists, please manually delete it before re-running")
    else:
...
def main_test(args):
    ...
    if os.path.isdir(test_out_dir):
        raise ValueError(f"{test_out_dir} already exists, please manually delete it before re-running")
    else:
